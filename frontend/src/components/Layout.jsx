      ...
      <div className="min-h-screen bg-white font-sans text-gray-800">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between h-16">
              <div className="flex items-center">
                <Link
                    to="/"
                    className="text-2xl font-extrabold text-maroon-900 flex items-center gap-2"
                >
                ...
                {isConnected && (
                    <div className="hidden md:flex ml-10 space-x-8">
                      ...
                      <Link to="/propose" className={isActive("/propose")}>
                        Raise Proposal
                      </Link>
                      <Link to="/pay" className={isActive("/pay")}>
                        Pay Dues
                      </Link>
                      <Link to="/open" className={isActive("/open")}>
                        Companies
                      </Link>
                    </div>
                )}
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <AnimatePresence mode="wait" initial={false}>
            <motion.div
                key={location.key}   // ✅ important for true global animation
